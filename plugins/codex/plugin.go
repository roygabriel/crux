...
// Plugin implements plugin.AgentPlugin for the OpenAI Codex CLI.
type Plugin struct{}

// New creates a new Codex CLI plugin instance.
func New() *Plugin {
	return &Plugin{}
}
...
// shows a Codex CLI ready prompt (">" or "codex>").
...
// characters or activity text indicating Codex CLI is processing.
...
// DetectPrompt returns false; Codex CLI does not produce interactive prompts
...
// sending to Codex CLI via tmux send-keys.
...
// captured after Codex CLI finishes processing.
...
// Capabilities returns the capabilities supported by Codex CLI:
